                        ...
                        <div class="col-lg-9 col-md-8 col-6">
                            <div class="header-bottom-right">
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            <li class="top-hover"><a href="shome.php">home</a>
                                                
                                            </li>
                                            <li><a href="sabout.php">about</a></li>
                                            <!-- <li><a href="product.php">Property</a></li> -->
                                            <li class="mega-menu-position top-hover"><a href="">Property</a>
                                                <ul class="mega-menu">
                                                    <li>
                                                        <li><a href="product.php">Add Property</a></li>
                                                        <li><a href="product_check.php">Show Property</a></li>
                                                        
                                                    </li>    
                                                </ul>
                                            </li>
                                            <li class="mega-menu-position top-hover"><a href="">REPORT</a>
                                                <ul class="mega-menu">
                                                    <li>
                                                        <li><a href="rreg.php">TENANT</a></li>
                                                        <li><a href="cartreport_admin.php">CART REPORTS</a></li>
                                                        <li><a href="conform_house.php">COFORM HOUSE</a></li>
                                                        <li><a href="SHOWBILL.php">BILL</a></li>
                                                        <!-- <li ><a href="selling_report.php">SELLING PERCENTAGE</a></li> -->
                                                    </li>    
                                                </ul>
                                            </li>
