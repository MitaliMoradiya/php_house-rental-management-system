...
<link rel="stylesheet" href="assets/css/jquery-ui.css">
    ...
    <?php require_once './after_slogin.php'; ?>
            ...
            <div class="container">
                ...
                <div class="row">
                   ...
                   <?php
                        ...
                        $q = mysqli_query($conn, "select * from tbl_conform");
                        $i = 0;
     ...
     echo "<center>";
     echo "<table border=3px solid black style=text-align:center><tr><th style=width:600px>Total booking house</th><td style=width:350px>$customer</td></tr></table><br></br>";
     echo "</center>";    
     ?>
                        <form action="#">
