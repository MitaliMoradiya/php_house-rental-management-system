                            ...
                            <div class="col-lg-9 col-md-8 col-6">
                                <div class="header-bottom-right">
                                    <div class="main-menu">
                                        <nav>
                                            <ul>
                                                <li class="top-hover"><a href="after_home.php">home</a>
                                                    
                                                </li>
                                                <li><a href="about-us.php">about</a></li>
                                                <li><a href="shop_product.php">property</a>
                                                <!-- <ul class="mega-menu">
                                                            <li>
                                                                <li><a href="shop_product.php">Properties</a></li>

                                                            </li> 
                                                            </ul> -->
                                                </li>
                                                <li><a href="cart-page.php">Favrorite</a></li>
